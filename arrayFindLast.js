...
/* Array.findLast() - Tal qual o array.find(). Array.findLast() Retorna o valor do PRIMEIRO elemento array que satisfaz a função provida, contudo percorrendo o array da ultima posição para a primeira. Se nenhum for achado, retorna -1.
...
function verificaAluno(e) {
    const arrayFindLast = estudantes.findLast(aluno => aluno.sexo == e);
    return arrayFindLast;
}

console.log(verificaAluno("Feminino"));
// Retorna { nome: "Laura Rodrigues", idade: 24, altura: 1.58, sexo: "Feminino", materia: "JavaScript", valor: 120 }